...
class ListeyeThreeItemWidget extends StatelessWidget {
  ListeyeThreeItemWidget();
    ...
    return IntrinsicWidth(
      child: Align(
        ...
        child: Container(
          ...
          decoration: AppDecoration.outlineGray9001e.copyWith(
                  ...
                  children: [
                    CustomIconButton(
                      ...
                      child: CustomImageView(
                        svgPath: ImageConstant.imgEyeWhiteA700,
                      ),
                    ),
                    Padding(
                      padding: getPadding(
